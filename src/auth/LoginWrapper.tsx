        ...
        <div className="mt-16 w-full border-t border-t-slate-200 bg-white">
          <div className="mx-auto flex max-w-5xl flex-col p-8 md:flex-row md:gap-12">
            ...
            <div className="flex flex-col gap-3 pt-10 text-sm">
              <A to={'https://kolbord.com/'} target="_blank" mono>
                About
              </A>
              <A to={'https://kolbord.com/solutions'} target="_blank" mono>
                Solutions
              </A>
              <A to={'https://kolbord.com/pricing'} target="_blank" mono>
                Pricing
              </A>
              <A to={'https://kolbord.com/faq'} target="_blank" mono>
                FAQ
              </A>
              <A
